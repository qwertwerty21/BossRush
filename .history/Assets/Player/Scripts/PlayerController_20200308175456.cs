...
namespace UnityStandardAssets.Characters.FirstPerson
{
  ...
  public class PlayerController : MonoBehaviour
  {
    ...
    private void OnTriggerEnter(Collider otherCollider)
    {
      ...
      {
        Vector3 direction = m_RigidBody.transform.position - otherCollider.transform.position;
        float force = otherCollider.gameObject.GetComponent<EnemyHitBox>().GetKnockbackForce();
