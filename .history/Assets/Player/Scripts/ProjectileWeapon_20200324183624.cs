...
public class ProjectileWeapon : MonoBehaviour
{
  ...
  {
    Debug.Log("m_crosshairname " + m_CrosshairName);
    m_CrosshairSprite = Resources.Load<Sprite>("CursorsAndCrosshairs/FreeCrosshairs/Crosshair12");
    Debug.Log("m_crosshairsprite " + m_CrosshairSprite);
    var CrosshairImage = GameObject.FindGameObjectWithTag("Crosshair");
