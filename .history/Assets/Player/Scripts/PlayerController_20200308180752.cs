...
namespace UnityStandardAssets.Characters.FirstPerson
{
  ...
  public class PlayerController : MonoBehaviour
  {
    ...
    private void OnTriggerEnter(Collider otherCollider)
    {
      ...
      {
        EnemyHitBox enemyHitbox = otherCollider.gameObject.GetComponent<EnemyHitBox>();
        Vector3 direction = enemyHitbox.GetDirection();
        float force = enemyHitbox.GetKnockbackForce();
