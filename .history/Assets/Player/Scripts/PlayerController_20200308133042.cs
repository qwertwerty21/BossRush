  ...
  public class PlayerController : MonoBehaviour
  {
    ...
    private void FixedUpdate()
    {
      ...
      if (m_CanDash)
      {
        ...
        // m_RigidBody.WakeUp();
        Vector3 force = new Vector3(m_MoveDir.x * m_DashThrust, m_MoveDir.y, m_MoveDir.z * m_DashThrust);
        m_RigidBody.AddForceAtPosition(force, m_RigidBody.centerOfMass, ForceMode.Impulse);
        // m_RigidBody.isKinematic = true;
        // m_MoveDir.z = m_MoveDir.z * m_DashThrust;
        // m_MoveDir.x = m_MoveDir.x * m_DashThrust;
        m_CharacterController.velocity += Vector3.Scale(transform.forward,
                                     m_DashThrust * new Vector3((Mathf.Log(1f / (Time.deltaTime * Drag.x + 1)) / -Time.deltaTime),
                                                                0,
