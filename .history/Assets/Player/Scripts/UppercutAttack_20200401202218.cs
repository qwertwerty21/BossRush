...
public class UppercutAttack : MonoBehaviour
{
  ...
  private void OnTriggerEnter(Collider otherCollider)
  {
    ...
    {
      AIBossController bossController = otherCollider.gameObject.GetComponent<AIBossController>();
      ...
      Debug.Log("fuckfasdkfdsak;lkl;" + bossController);
      bossController.AddImpact(Vector3.forward, force);
    }
  }
}
