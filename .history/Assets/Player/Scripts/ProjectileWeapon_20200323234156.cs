...
public class ProjectileWeapon : MonoBehaviour
{
  ...
  private int m_PlayerLayer = 8;
  // Bit shift the index of the layer (8) to get a bit mask
  private int m_LayerMask = 1 << m_PlayerLayer;
  ...
  {
    RaycastHit hit;
    // This would cast rays only against colliders in layer m_PlayerLayer.
    // But instead we want to collide against everything except layer m_PlayerLayer. The ~ operator does this, it inverts a bitmask.
