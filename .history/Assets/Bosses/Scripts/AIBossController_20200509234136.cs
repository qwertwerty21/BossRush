...
public abstract class AIBossController : MonoBehaviour
{
  ...
  [SerializeField] private float m_NavMeshAgentUpdateThreshold = 1.5f;
  ...
  virtual protected void Update()
  {
    ...
    if (!m_IsNavMeshAgentUpdating && m_RigidBody.velocity.magnitude < m_NavMeshAgentUpdateThreshold)
    {
